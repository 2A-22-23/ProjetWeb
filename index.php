            ...
            <div class="row d_flex">
                  ...
                  <nav class="navigation navbar navbar-expand-md navbar-dark ">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                           ...
                           <li class="nav-item">
                              <a class="nav-link" href="domain.php">Pick up points</a>
                           </li>
                           <li class="nav-item">
               ...
               <div class="col-md-2  d_none">
                  <ul class="email text_align_right">
                     <li><a href="Javascript:void(0)"> <i class="fa fa-shopping-bag" aria-hidden="true"> <span>45</span></i>
                        </a>
                     </li>
                           ...
                           <div class="carousel-item active">
                              <div class="carousel-caption relative">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="dream_img">
                                          <figure><img src="images/dream_img.png" height='200px' alt="#"/></figure>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="carousel-caption relative">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="dream">
                                          <h1>
                                             It's only <br>Starts <br>By <br>A clic
                                          </h1>
                                          <a class="read_more" href="Javascript:void(0)">Get Stared</a>    
                                          <a class="read_more" href="Javascript:void(0)">Contact Us</a>
                                       </div>
                              ...
                              <div class="carousel-caption relative">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="dream">
                                          <h1>
                                             Joins <br>Our <br>Comunity <br>Now!
                                          </h1>
                                          <a class="read_more" href="Javascript:void(0)">Get Stared</a>    
                                          <a class="read_more" href="Javascript:void(0)">Contact Us</a>
                                       </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>all starts with  <span class="blue_light">a Simple Clic</span></h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="form">
                     <div class="searchbar">
                        <input class="search_input" type="text" name="" placeholder="Search an activity">
                     ...
                     <div class="row">
                        <div class="col-sm-2">
                           <div class="domain-price">
                              <strong>Objective <br> Per Month</strong>
                           </div>
                        </div>
                        <div class="col-sm-10">
      ...
      <div class="guarantee">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>Sit Back, Recline, and Let Us  <span class="blue_light">Take Care of the Rest!</span></h2>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Plastic caps</h3>
                        <p>Let's collect together and with only 30Kg of plastic caps we can help one dishabled person to have a wheel chair</p>
                     </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Books</h3>
                        <p>Recycling books promotes sustainability, conserves resources, and reduces waste, making it a simple way to contribute to a greener future. So, next time you're done with a book, consider recycling it!</p>
                     </div>
                     <a class="read_more" href="hosting.html">Read More</a>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <p>Recycling bottles conserves resources, reduces waste, and minimizes environmental pollution, supporting sustainability by promoting the reuse of valuable materials.</p>
                     </div>
                     <a class="read_more" href="hosting.html">Read More</a>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <div class="titlepage text_align_center">
                     <h2>Check Out Awesome Plans, <br> <span class="blue_light">Join Now</span></h2>
                     <p>We provide for you different types of plans so you can help however you want . Recycle,Revive,Be Happy
                     </p>
                  </div>
               </div>
            </div>
